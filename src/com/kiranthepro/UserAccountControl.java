...
public class UserAccountControl {
	...
	public static void addUser() {
		...
		while (!checkUsername(username)) {
			System.out.println("Please type your username in the form of a valid email address.");
			username = getInputNNL("Username: ");
		}
	...
	public static void deleteUser() {
		ArrayList<JSONObject> allAccounts = getAllAccountInfo("users.json");

		JSONObject accountToDelete = getAccount(getInputNNL("Type the username of the account: "));
